...
The final code for our mongodb data connector can be found in the
[src/data-connectors/mongodb.js](https://github.com/hydrateio/advanced-graphql-server-tutorial/blob/step-4-separate-data-source/src/data-connectors/mongodb.js)
source file.
